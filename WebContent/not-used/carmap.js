...
angular.module("carmap", [ "ui.bootstrap" ])

.controller("myController", function($scope, $http, $modal) {
...
.controller("modalController", function($scope, $http, $modalInstance, modalData) {
    $scope.message = modalData;
})
